function [B_trn,B_tst] = demo_coding(exp_data, param, method,LSHparam)
% input:
%          data:
%              data.train_data
%              data.test_data
...
switch(method)
    ...
    case 'BRE' % it runs too much slow, and I don't get the result.
        ...
        save('DB-FeaturesAfterProcessing\cifa10_tr50000_LSH.mat','B_trn')
...
% [Orderhamm, rank] = sort(Dhamm, 2, 'ascend');
% recall = Recall_comp(rank);
% recall = Recall_comp_normal(rank);
end
